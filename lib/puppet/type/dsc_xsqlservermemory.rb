...
Puppet::Type.newtype(:dsc_xsqlservermemory) do
...
Puppet::Type.type(:dsc_xsqlservermemory).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
